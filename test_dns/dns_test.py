...
def add_txt_record(record_name: str, record_content: str):
    ...
    try:
        ...
        logger.error('Encountered error adding TXT record: {0}'
                                     .format(e))
    
    try:
        answer = socket.recv()
    except Exception as e:
        logger.error('Encountered error adding TXT record, receive reply: {0}'
                                     .format(e))
    else:
        ...
        if answer == 'OK':
            ...
            logger.error('Encountered error add TXT, bad reply: {0}'
                                        .format(answer)) 
    socket.close()
...
def add_a_record(record_name: str):
    ...
    try:
        ...
        logger.error('Encountered error adding SUBDOMAIN record: {0}'
                                     .format(e))
    try:
        answer = socket.recv()
    except Exception as e:
        ...
        if answer == 'OK':
            ...
            logger.error('Encountered error add DOMAIN %s, bad reply: {0}'
                                         .format(answer)) 
    socket.close()
...
def del_txt_record(record_name: str, record_content: str):
    ...
    try:
        ...
        logger.error('Encountered error adding TXT record, send request: {0}'
                                     .format(e))
    try:
        answer = socket.recv()
    except Exception as e:
        ...
        if "OK" == answer:
            ...
            logger.error('Encountered error remove TXT record, bad reply: {0}'
                                     .format(answer)) 
    socket.close()
...
def del_a_record(record_name: str):
    ...
    try:
        ...
        logger.error('Encountered error remove subdomain, send request: {0}'
                                     .format(e))
    try:
        answer = socket.recv()
    except Exception as e:
        logger.error('Encountered error remove subdomain, receive reply: {0}'
                                     .format(e))
    else:
        answer = answer.decode("utf-8")
        if "OK" == answer:
            ...
            logger.error('Encountered error remove subdomains, bad reply: {0}'
                                     .format(answer)) 
    socket.close()
...
if __name__ == "__main__":
    ...
    add_txt_record('_acmechallenge.psa.iotdns.v-odoo.com','TRW4HC1Wtzhr6Z9DiEMpqVOMu87QUgYaCeEcFoIgLHQ')
    #time.sleep(1)
